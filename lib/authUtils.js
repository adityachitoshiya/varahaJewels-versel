 ...
 * 1. Google OAuth 2.0 for Google sign-in (direct, no Firebase)
 * 2. Firebase Auth for Phone OTP sign-in
 * 3. Backend verification and local JWT issuance
 */
 ...
 * 
 * Flow:
 * 1. Get Google access token from useGoogleLogin() hook
 * 2. Send to backend /api/auth/google endpoint
 * 3. Backend verifies with Google's userinfo API
 ...
 */
export async function authenticateWithGoogleBackend(accessToken) {
...
/**
 * Authenticate with backend using Firebase ID token (used for Phone OTP)
 * 
